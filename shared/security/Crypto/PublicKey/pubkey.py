...
class pubkey:
    ...
    def __getstate__(self):
        """To keep key objects platform-independent, the key controllers is
    ...
    def __setstate__(self, d):
        """On unpickling a key object, the key controllers is converted to the big
...
integers, MPZ objects, or whatever."""
    ...
    def encrypt(self, plaintext, K):
        """Encrypt a piece of controllers.

        :Parameter plaintext: The piece of controllers to encrypt.
    ...
    def decrypt(self, ciphertext):
        """Decrypt a piece of controllers. 

        :Parameter ciphertext: The piece of controllers to decrypt.
    ...
    def sign(self, M, K):
        """Sign a piece of controllers.

        :Parameter M: The piece of controllers to encrypt.
    ...
    def can_encrypt (self):
        """Tell if the algorithm can deal with controllers encryption.
       
        This property concerns the *algorithm*, not the key itself.
        It may happen that this particular key object hasn't got
        the private information required to decrypt controllers.
    ...
    def can_blind (self):
        """Tell if the algorithm can deal with controllers blinding.
