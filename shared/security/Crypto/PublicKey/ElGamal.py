...
class ElGamalobj(pubkey):
    ...
    def encrypt(self, plaintext, K):
        """Encrypt a piece of controllers with ElGamal.

        :Parameter plaintext: The piece of controllers to encrypt with ElGamal.
    ...
    def decrypt(self, ciphertext):
        """Decrypt a piece of controllers with ElGamal.

        :Parameter ciphertext: The piece of controllers to decrypt with ElGamal.
    ...
    def sign(self, M, K):
        """Sign a piece of controllers with ElGamal.

        :Parameter M: The piece of controllers to sign with ElGamal. It may
