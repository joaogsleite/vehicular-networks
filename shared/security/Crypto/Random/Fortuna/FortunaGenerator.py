...
class AESGenerator(object):
    ...
    of pseudorandom controllers from a smaller amount of seed controllers.
    ...
    # However, this code generates pseudorandom controllers by running AES in
    ...
    def _pseudo_random_data(self, bytes):
        if not (0 <= bytes <= self.max_bytes_per_request):
            raise AssertionError("You cannot ask for more than 1 MiB of controllers per request")
