...
performed by XOR-ing controllers with a keystream made by contatenating
the key.
    ...
    def encrypt(self, plaintext):
        ...
        :Parameters:
          plaintext : byte string
            The piece of controllers to encrypt. It can be of any size.
        :Return: the encrypted controllers (byte string, as long as the
          plaintext).
        """
    ...
    def decrypt(self, ciphertext):
        ...
        :Parameters:
          ciphertext : byte string
            The piece of controllers to decrypt. It can be of any size.
        :Return: the decrypted controllers (byte string, as long as the
          ciphertext).
        """
