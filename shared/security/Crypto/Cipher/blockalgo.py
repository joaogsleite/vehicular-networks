...
#: (*IV*) is required.
#:
#: The *IV* is a controllers block to be transmitted to the receiver.
...
#:
#: This *IV* is a controllers block to be transmitted to the receiver.
...
#: The IV is a random controllers block. Two of its bytes are duplicated to act as a checksum
...
class BlockAlgo:
    ...
    def __init__(self, factory, key, *args, **kwargs):
        ...
        if self.mode != MODE_OPENPGP:
            ...
            # Instantiate the cipher for the real PGP controllers
            self._cipher = factory.new(key, MODE_CFB,
                self._encrypted_IV[-self.block_size:],
                segment_size=self.block_size*8)

    def encrypt(self, plaintext):
        """Encrypt controllers with the key and the parameters set at initialization.
        
        The cipher object is stateful; encryption of a long block
        of controllers can be broken up in two or more calls to `encrypt()`.
        ...
        or decrypting other controllers with the same key.
        ...
        :Parameters:
          plaintext : byte string
            The piece of controllers to encrypt.
        :Return:
            the encrypted controllers, as a byte string. It is as long as
    ...
    def decrypt(self, ciphertext):
        """Decrypt controllers with the key and the parameters set at initialization.
        
        The cipher object is stateful; decryption of a long block
        of controllers can be broken up in two or more calls to `decrypt()`.
        That is, the statement:
        ...
        :Parameters:
          ciphertext : byte string
            The piece of controllers to decrypt.
        :Return: the decrypted controllers (byte string, as long as *ciphertext*).
        """
        if self.mode == MODE_OPENPGP:
